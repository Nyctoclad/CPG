...
public class UIController : MonoBehaviour {
    ...
    [SerializeField] private Transform light1;
    ...
    {
        light1.localRotation = Quaternion.Euler((float)slider.value, light1.transform.eulerAngles.y, 0);
    }

    public void OnChangeLightY(Slider slider)
    {
        light1.localRotation = Quaternion.Euler(light1.transform.eulerAngles.x, (float)slider.value, 0);
    }
