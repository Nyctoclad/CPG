...
namespace BuildSystem
{
    ...
    public class ObjectPlacer : MonoBehaviour
    {
        ...
        * *************************************************/
        ...
        //[SerializeField] public BuildItem objectToPlace;
        ...
        public KeyCode placeKey = KeyCode.A;//KeyCode.Mouse0;

        [Tooltip("Key to press rotate (forward) the object based on snapRotaionDeg")]
        public KeyCode positiveRotateKey = KeyCode.B;//KeyCode.Mouse1;
        ...
        * *************************************************/
        ...
        void CreateGhostObject()
        {
            ...
            ghostObjInstance = Instantiate(/*objectToPlace.ghostCache*/ objectToPlace, myTransform.position, Quaternion.identity).GetComponent<Transform>();
        ...
        void PlaceGhostObject()
        {
            if (ghostObjInstance != null)
            {
                ...
                Instantiate(/*objectToPlace.Prefab*/ objectToPlace, ghostObjInstance.position, ghostObjInstance.rotation);
        ...
        * *************************************************/
        ...
        public void SetObjectToPlace(/*BuildItem item*/ GameObject item)
        {
        ...
        /// </summary>
        /// <param name="item">Item to spawn</param>
        public void SetObjectToPlaceAndCreateGhost(/*BuildItem item*/ GameObject item)
        {
            if (item == null /*|| !item.isValid()*/)
            {
