    ...
    public class ObjectSelector : MonoBehaviour
    {
        ...
        * *************************************************/
        ...
        private void Start()
        {
            ...
            objPlacer.SetObjectToPlace(buildObjectList.items[0].Prefab); //use the first item as default and set it
        }
        ...
        * *************************************************/
        ...
        public void UseItem(int index)
        {
            ...
            {
                objPlacer.SetObjectToPlaceAndCreateGhost(buildObjectList.items[index].Prefab);
